...
<!-- Intro Section -->
<div class="mt-5 d-flex flex-wrap align-items-center gap-3" data-aos="fade-right" data-aos-delay="100">
    <div class="flex-grow-1 px-2" style="min-width: 250px; max-width: 900px;">
        <p>
            Artificial Intelligence (AI) plays a transformative role in Energy Management Systems (EMS), enhancing efficiency,
            reliability, and sustainability. Here are some key ways AI is utilized in EMS in CF app.
        </p>
    </div>
</div>
...
@foreach ($features as $index => $feature)
    <div class="mt-4 d-flex flex-wrap align-items-start gap-3" data-aos="fade-left" data-aos-delay="{{ 200 + $index * 100 }}">
