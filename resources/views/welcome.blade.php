...
@keyframes floatUpDown {
    ...
    <section class="bg-white">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                <section data-aos="fade-up" style="padding: 10px 5%; display: flex; flex-direction: column; gap: 60px; position: relative; overflow: hidden;">

    <!-- Background Decorative Images -->
    <img src="{{ asset('frontend/images/bgimage1.png') }}"
         alt="Decorative Background2"
         style="position: absolute; left: 0; bottom: 0; height: 200px; opacity: 0.1; z-index: 1; pointer-events: none;"
         data-aos="fade-right" data-aos-delay="100">
         
    <img src="{{ asset('frontend/images/dotted.png') }}"
         alt="Decorative Background3"
         style="position: absolute; left: 0; bottom: 1060px; height: 220px; opacity: 0.1; z-index: 1; pointer-events: none;"
    ...
    <div class="mt-5"
         ...
         data-aos="fade-right" data-aos-delay="100">
        <div style="flex: 1 1 100%; min-width: 250px; max-width: 900px; padding: 0 10px;">
...
<!-- Optional: Add this in your <style> tag or CSS file if not using Tailwind or Bootstrap -->
<style>
    @media (max-width: 768px) {
        section {
            padding: 10px 5%;
