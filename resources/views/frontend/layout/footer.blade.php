        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="footer-brand d-flex align-items-center mb-4">
                    ...
                    <h4 class="text-white mb-0">CF<span class="text-gradient">Smart Technology</span></h4>
                </div>
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="footer-links list-unstyled">
                    <li class="mb-3">
                        <a href="#" class="footer-link text-white text-decoration-none position-relative">
                    ...
                    <li class="mb-3">
                        <a href="#" class="footer-link text-white text-decoration-none position-relative">
                            <span class="link-text">Security Systems</span>
                            <span class="link-hover"></span>
                        </a>
                    </li>
                    <li class="mb-3">
                        <a href="#" class="footer-link text-white text-decoration-none position-relative">
                            <span class="link-text">Energy Saving</span>
                            <span class="link-hover"></span>
                        </a>
                    </li>
                    <li class="mb-3">
                        <a href="#" class="footer-link text-white text-decoration-none position-relative">
                            <span class="link-text">Voice Control</span>
                            <span class="link-hover"></span>
                        </a>
                    </li>
                </ul>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <h6 class="footer-heading text-uppercase fw-bold mb-4">Stay Updated</h6>
                <p class="text-white mb-4">Subscribe to our newsletter for the latest smart home trends and
                    exclusive offers.</p>
